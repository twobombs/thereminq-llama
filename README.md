...
```bash
docker run --gpus all -v /path-to-/models:/text-generation-webui/models  -p 5173:5173 -p 5601:5601 -p 6080:6080 -p 7860:7860 -p 8501:8501 -p 8081:8081 -d twobombs/thereminq-llama[:tag] 
````
